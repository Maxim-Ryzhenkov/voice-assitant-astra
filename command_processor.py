...
class CommandProcessor:
    ...
    def text_content_assistants_name(self, user_text: str) -> set:
        return Config.ASSISTANT.name_options.intersection(user_text.split())
    ...
    def replace_assistant_name_from_text(self, user_text):
        names_in_text = Config.ASSISTANT.name_options.intersection(user_text.split())
        user_text.replace(list(names_in_text)[0], '')   # Удалить первое вхождение имени ассистента в тексте.
